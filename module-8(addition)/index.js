...
class Gallery {
    ...
    galleryRendering() {
        ...
        this.parentNode.append(fullview, itemList);
        ...
        this.parentNode.addEventListener('click', this.galleryEventClick);

    }
    galleryEventClick(event) {
...
const gallery = new Gallery([
    ...
    { preview: 'img/pic-6.jpg', fullview: 'img/pic-6.jpg', alt: "alt text 6" },
], document.querySelector('.image-gallery'), 2)
...
const gallery2 = new Gallery([
    ...
    { preview: 'img/pic-6.jpg', fullview: 'img/pic-6.jpg', alt: "alt text 6" },
    { preview: 'img/pic-6.jpg', fullview: 'img/pic-6.jpg', alt: "alt text 6" },
], document.querySelector('.js-image-gallery2'), 2)
